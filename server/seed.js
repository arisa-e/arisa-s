...
async function main(){
    const uri ="mongodb+srv://arisa-s:arisa34132990@arisa.jpkbtfv.mongodb.net"
    const client = new MongoClient(uri)

    try{
        await client.connect()
        const productsCollection = client.db("tasty").collection("products")
        const categoriesCollection = client.db("tasty").collection("categories")
